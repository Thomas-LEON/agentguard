...
_SYSTEM_PROMPT = """You are an expert security engineer reviewing code generated by an AI agent.
    ...
    def validate(self, code: str) -> None:
        ...
        if verdict != "SAFE":
            raise SecurityBlockedError(
                ...
                reason="LLM analysis detected potentially malicious intent in the code.",
                code=code,
            )
